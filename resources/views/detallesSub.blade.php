...
@if(isset($categorias))
  ...
  @if($categoria->name=="Higiene Personal"||$categoria->name=="Superficies y Pisos"||$categoria->name=="Repelentes"||$categoria->name=="Ropa"||$categoria->name=="Varios")
      <h2 class="titulo-productos"><strong>Perfumería y Limpieza</strong></h2>
  @elseif($categoria->name=="Con Alcohol"||$categoria->name=="Sin Alcohol")
    <h2 class="titulo-productos"><strong>Bebidas</strong></h2>
      ...
      <h2 class="titulo-productos"><strong>Comestibles</strong></h2>
      @endif
  @endforeach
