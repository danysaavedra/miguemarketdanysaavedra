...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <ul class="nav">
            <li>
              <a href="">
                <ion-icon name="beer-outline"></ion-icon><br>Productos<span class="flecha">&#9660;</span>
              </a>
              <ul>
            ...
            <li><a href="/">
                <ion-icon name="home-outline"></ion-icon> <br> Home
              </a></li>

            @if((Auth::user()) && (Auth::user()->admin))
            <li>
              <a href="/productos/agregar">
                <ion-icon name="beer-outline"></ion-icon><br>Crear<br>Producto
              </a>
            </li>
  ...
  <li class="nav-item active">
    <a  href="/subcategoriecreate"><i class="fas fa-plus"></i></i></ion-icon><br>Agregar <br> Subcategoria </a>
            ...
            <li class="nav-item active">
              <a href="/carrito">
                <ion-icon name="cart-outline"></ion-icon></i>
            ...
            <li class="nav-item active">
              <a href="/register">
                <ion-icon name="pencil-outline"></ion-icon></i><br>Registrate
              </a>
            </li>
            <li class="nav-item active">
              <a href="/login">
                <ion-icon name="person-outline"></ion-icon><br>Login
              </a>
            </li>
            @else
            <ul>
